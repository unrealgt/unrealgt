...
void FUnrealGTModule::StartupModule() {
...

  {
    ...
    MenuExtender->AddMenuExtension(
        ...
        FMenuExtensionDelegate::CreateRaw(this,
                                          &FUnrealGTModule::AddMenuExtension));
...

  {
    ...
    ToolbarExtender->AddToolBarExtension(
        ...
        FToolBarExtensionDelegate::CreateRaw(
            this, &FUnrealGTModule::AddToolbarExtension));
  ...
  FGlobalTabmanager::Get()
      ->RegisterNomadTabSpawner(
          TrainerTabName,
          FOnSpawnTab::CreateRaw(this, &FUnrealGTModule::OnSpawnPluginTab))
...
#if WITH_EDITOR
TSharedRef<SDockTab>
FUnrealGTModule::OnSpawnPluginTab(const FSpawnTabArgs &SpawnTabArgs) {
